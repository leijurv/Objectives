...
public class RenderChunk {
   ...
   public void func_178570_a(float p_178570_1_, float p_178570_2_, float p_178570_3_, ChunkCompileTaskGenerator p_178570_4_) {
      ...
      if(var5.func_178487_c() != null && !var5.func_178491_b(EnumWorldBlockLayer.TRANSLUCENT)) {
         ...
         p_178570_4_.func_178545_d().func_179038_a(EnumWorldBlockLayer.TRANSLUCENT).func_178993_a(var5.func_178487_c());
   ...
   public void func_178581_b(float p_178581_1_, float p_178581_2_, float p_178581_3_, ChunkCompileTaskGenerator p_178581_4_) {
      ...
      if(!var9.func_72806_N()) {
         ++field_178592_a;
         Iterator var11 = BlockPos.func_177975_b(var7, var8).iterator();

         while(var11.hasNext()) {
            BlockPos.MutableBlockPos var12 = (BlockPos.MutableBlockPos)var11.next();
            IBlockState var13 = var9.func_180495_p(var12);
            Block var14 = var13.func_177230_c();
            if(var14.func_149662_c()) {
               var10.func_178606_a(var12);
            }

            if(var14.func_149716_u()) {
               TileEntity var15 = var9.func_175625_s(new BlockPos(var12));
               if(var15 != null && TileEntityRendererDispatcher.field_147556_a.func_147545_a(var15)) {
                  var5.func_178490_a(var15);
               }
            }

            EnumWorldBlockLayer var24 = var14.func_180664_k();
            int var16 = var24.ordinal();
            if(var14.func_149645_b() != -1) {
               ...
               if(Minecraft.func_71410_x().func_175602_ab().func_175018_a(var13, var12, var9, var17)) {
   ...
   private void func_178573_a(WorldRenderer p_178573_1_, BlockPos p_178573_2_) {
      p_178573_1_.func_178964_a(7);
      p_178573_1_.func_178967_a(DefaultVertexFormats.field_176600_a);
   ...
   private void func_178584_a(EnumWorldBlockLayer p_178584_1_, float p_178584_2_, float p_178584_3_, float p_178584_4_, WorldRenderer p_178584_5_, CompiledChunk p_178584_6_) {
      if(p_178584_1_ == EnumWorldBlockLayer.TRANSLUCENT && !p_178584_6_.func_178491_b(p_178584_1_)) {
         p_178584_6_.func_178494_a(p_178584_5_.func_178971_a(p_178584_2_, p_178584_3_, p_178584_4_));
      }
