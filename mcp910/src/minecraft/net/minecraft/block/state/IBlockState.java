...
public interface IBlockState {
	...
	/**
	 * Get a version of this BlockState with the given Property now set to the
	 * given value
	 */
	...
	/**
	 * Get all properties of this BlockState. The returned Map maps from
	 * properties (IProperty) to the respective current value.
	 */
